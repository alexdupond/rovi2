...
public:
	...
	Matrix4f get_pose_global(PointCloud<PointXYZ>::Ptr scene_in, PointCloud<PointXYZ>::Ptr object_in, size_t iter = 4000);
	Matrix4f get_pose_global(PointCloud<PointXYZ>::Ptr scene_in, string object_name, size_t iter = 4000);
	Matrix4f get_pose_local(PointCloud<PointXYZ>::Ptr scene_in, PointCloud<PointXYZ>::Ptr object_in, size_t iter = 50, float thressq = 0.0001);
