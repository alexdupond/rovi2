...
public:
    ...
    bool calculateDynamicRRTPath(const vector<rw::math::Q>& qVec, rw::trajectory::QPath& qPathRob1, rw::trajectory::QPath& result, caros::SerialDeviceSIProxy* rob1, caros::SerialDeviceSIProxy* rob2);
