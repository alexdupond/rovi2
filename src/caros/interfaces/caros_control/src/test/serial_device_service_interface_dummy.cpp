...
bool SerialDeviceServiceInterfaceDummy::moveLin(const TransformAndSpeedAndAccelerationContainer_t& targets)
{
...
bool SerialDeviceServiceInterfaceDummy::movePtp(const QAndSpeedAndAccelerationContainer_t& targets)
{
  most_recent_function_called_ = __PRETTY_FUNCTION__;
  if (cause_error_)
  {
...
bool SerialDeviceServiceInterfaceDummy::movePtpT(const TransformAndSpeedAndAccelerationContainer_t& targets)
{
  most_recent_function_called_ = __PRETTY_FUNCTION__;
  if (cause_error_)
  {
...
bool SerialDeviceServiceInterfaceDummy::moveServoQ(const rw::math::Q& target, const float time, const float lookahead_time,
                                                   const float gain)
{
  most_recent_function_called_ = __PRETTY_FUNCTION__;
  if (cause_error_)
...
bool SerialDeviceServiceInterfaceDummy::moveServoUpdate(const rw::math::Q& target)
{
  most_recent_function_called_ = __PRETTY_FUNCTION__;
  if (cause_error_)
  {
...
bool SerialDeviceServiceInterfaceDummy::moveServoStop()
{
  most_recent_function_called_ = __PRETTY_FUNCTION__;
  if (cause_error_)
  {
